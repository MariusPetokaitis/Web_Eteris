...
function render_page($license=false) {
	...
	//Header
	echo "<table cellspacing='0' cellpadding='' width='".THEME_WIDTH."' class='outer-border center'>\n<tr>\n";
	echo "<td>\n";
	echo "<table cellpadding='0' cellspacing='0' width='999'>\n<tr>\n";
	echo "<tr><td height='228' background='".THEME."images/banner.jpg' align='right' valign='middle'>
	<table width='999' border='0' cellspacing='0' cellpadding='0'><tr><td>&nbsp;</td><td width='230' align='center'>";
	echo "</tr>\n</table>\n";
	echo "</td>\n</tr>\n</table>\n";
	...
	//Footer
	echo "</tr>\n</table>\n";
	echo "<table cellpadding='0' cellspacing='0' width='999' height='100' align='center'>\n<tr>\n";
	echo "<td align='center' class='footer'>".stripslashes($settings['footer'])."<br />\n";
	if (!$license) { echo showcopyright()."<br /<span style='font-size: 10px'>Forest by  |  - \n"; } echo showcounter()."<br /><br />\n";
	echo "</td>\n</tr>\n</table>\n";
	echo "</td>\n</tr>\n</table>\n";
...
function render_news($subject, $news, $info) {
	...
	echo "<table cellpadding='0' cellspacing='10' width='100%'>\n<tr>\n";
